...
exports.buildSwagger = function() {
    ...
    route.forEach(function(element, index) {
        ...
        if (element.method.toUpperCase() == 'POST') {
            swaggerObj["paths"][element.path][element.method]["operationId"] = 'sendUsingPOST' + basicFunc.randomString(8);
        } else {
            swaggerObj["paths"][element.path][element.method]["operationId"] = 'implUsingGET' + basicFunc.randomString(8);
        }
